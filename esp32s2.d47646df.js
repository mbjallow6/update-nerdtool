...
parcelRegister("40FPK", function(module, exports) {

$parcel$export(module.exports, "ESP32S2ROM", () => $2eb79ccec57c6a7f$export$4fb717d12681de23);

var $SqC3K = parcelRequire("SqC3K");

var $eM5nu = parcelRequire("eM5nu");
class $2eb79ccec57c6a7f$export$4fb717d12681de23 extends (0, $SqC3K.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($eM5nu))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($eM5nu))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($eM5nu))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($eM5nu))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($eM5nu))).text;
    }
...
parcelRegister("eM5nu", function(module, exports) {
...
//# sourceMappingURL=esp32s2.d47646df.js.map
