...
parcelRegister("cUNbn", function(module, exports) {

$parcel$export(module.exports, "ESP32C2ROM", () => $9670dda3ff7055c4$export$8ad31a2aa21b3abf);

var $ixZfq = parcelRequire("ixZfq");

var $2goUB = parcelRequire("2goUB");
class $9670dda3ff7055c4$export$8ad31a2aa21b3abf extends (0, $ixZfq.ESP32C3ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($2goUB))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($2goUB))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($2goUB))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($2goUB))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($2goUB))).text;
    }
...
parcelRegister("2goUB", function(module, exports) {
...
//# sourceMappingURL=esp32c2.994f71d9.js.map
