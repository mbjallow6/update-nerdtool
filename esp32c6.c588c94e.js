...
parcelRegister("fUN2o", function(module, exports) {

$parcel$export(module.exports, "ESP32C6ROM", () => $b9621fcfadd8b5be$export$652353697ef98b38);

var $SqC3K = parcelRequire("SqC3K");

var $fNlY7 = parcelRequire("fNlY7");
class $b9621fcfadd8b5be$export$652353697ef98b38 extends (0, $SqC3K.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($fNlY7))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($fNlY7))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($fNlY7))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($fNlY7))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($fNlY7))).text;
    }
...
parcelRegister("fNlY7", function(module, exports) {
...
//# sourceMappingURL=esp32c6.c588c94e.js.map
