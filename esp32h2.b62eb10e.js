...
parcelRegister("lbcVU", function(module, exports) {

$parcel$export(module.exports, "ESP32H2ROM", () => $f6b4a8463daa656c$export$2184cd7dbcdab15a);

var $SqC3K = parcelRequire("SqC3K");

var $iZT7C = parcelRequire("iZT7C");
class $f6b4a8463daa656c$export$2184cd7dbcdab15a extends (0, $SqC3K.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($iZT7C))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($iZT7C))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($iZT7C))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($iZT7C))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($iZT7C))).text;
    }
...
parcelRegister("iZT7C", function(module, exports) {
...
//# sourceMappingURL=esp32h2.b62eb10e.js.map
