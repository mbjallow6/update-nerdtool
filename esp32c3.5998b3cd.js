...
parcelRegister("ixZfq", function(module, exports) {

$parcel$export(module.exports, "ESP32C3ROM", () => $d80ad195d77cc701$export$d17dfcbab3a5ba52);

var $SqC3K = parcelRequire("SqC3K");

var $9aHtZ = parcelRequire("9aHtZ");
class $d80ad195d77cc701$export$d17dfcbab3a5ba52 extends (0, $SqC3K.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($9aHtZ))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($9aHtZ))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($9aHtZ))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($9aHtZ))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($9aHtZ))).text;
    }
...
parcelRegister("9aHtZ", function(module, exports) {
...
//# sourceMappingURL=esp32c3.5998b3cd.js.map
